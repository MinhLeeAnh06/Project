...
Route::get('blog',[\App\Http\Controllers\Front\Blog::class,'index']);
Route::get('blog/{id}',[\App\Http\Controllers\Front\Blog::class,'show']);
...
Route::prefix('admin')->middleware('CheckAdminLogin')->group(function (){
    ...
    Route::resource('blog',\App\Http\Controllers\Admin\BlogDetails::class);
    Route::resource('blog/{blogDetail}/image',\App\Http\Controllers\Admin\BlogImages::class);
